 ...
 *
 * Note: Clear All is ALSO available from MenuBar Edit menu (Cmd/Ctrl+Shift+R
 *   shortcut routes through shared ClearConfirmDialog in AppLayout). Both
 *   entry-points coexist by design.
 */
