  ...
  "1->0.3": (ws) => {
    return {
      ...
      settings: {
        ...
        structuralDiversityEnabled: ws.structuralDiversityEnabled,
        structuralKappa: ws.structuralKappa,
        ...
        evolveproRound: ws.evolveproRound,
        roundSize: ws.roundSize,
        overlapMode: ws.overlapMode,
      },
      results: {
