...
- **KURO** (Kit for Unified Ranking and Oligodesign) — Gibson Assembly 템플릿에서 SDM 프라이머를 일괄 설계한다.
- **MAME** (Mutagenesis Assessment & Measurement Export) — Oxford Nanopore 데이터에서 의도 변이 보유 클론을 판정한다.
