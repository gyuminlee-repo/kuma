...
- **Kuro** (Kit for Unified Ranking and Oligodesign) — Gibson Assembly 기반 SDM 프라이머 일괄 설계.
- **Mame** (Mutagenesis Assessment & Measurement Export) — Oxford Nanopore NGS 판정. 어떤 클론이 의도한 돌연변이를 가졌는지 검증.
...
- **Run** → 8-class 판정 테이블(PASS / WRONG_AA / AMBIGUOUS / MIXED / FRAMESHIFT / MANY / LOWDEPTH / NO_CALL)과 96-well 플레이트 맵 생성.
