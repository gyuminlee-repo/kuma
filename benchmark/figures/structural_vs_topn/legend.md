...
**(a)** Effect size (Cliff’s δ, structural κ=0 minus baseline; positive favours structural) across nine assays versus Top-N (circles) and versus UCB (diamonds), coloured by the respective 9-cell decision (green win, grey neutral, red loss); asterisks mark Holm-corrected Wilcoxon significance (P < 0.05, n = 9). Aggregate is 6 win / 2 neutral / 1 loss against BOTH baselines, but the composition differs: against Top-N the only loss is HIS7; against the stronger UCB the loss shifts to RASK (where UCB’s exploration is best) while HIS7 becomes a wash and F7YBW8 softens from FOR-STRONG to FOR-QUALIFIED. The edge therefore survives a real acquisition-function baseline, not just greedy Top-N.
