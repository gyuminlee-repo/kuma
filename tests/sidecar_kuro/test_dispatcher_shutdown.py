"""Tests for the §22 graceful shutdown RPC in the kuro sidecar dispatcher.
...
def _spawn_kuro_dispatcher() -> subprocess.Popen:
    """Spawn a kuro dispatcher subprocess with stdin/stdout pipes."""
    return subprocess.Popen(
        [
            ...
            (
                ...
                "from sidecar_kuro.dispatcher import main; "
